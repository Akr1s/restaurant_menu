...
const validateDish = (body) => {
  ...
  if (
    (0, validatorHelpers_1.propertiesAreMissing)(
      name,
      desc,
      img,
      show,
  ...
  if ((0, validatorHelpers_1.objectHasAdditionalProperties)(body, 6))
  ...
  if (
    ...
    return validationCodes_1.RESPONSE_CODES.DISHES_NAME_ERROR;
  if (
    (0, validatorHelpers_1.wrongType)(desc, "string") ||
    (0, validatorHelpers_1.stringLengthExeeds)(desc, 255)
  )
    return validationCodes_1.RESPONSE_CODES.DISHES_DESCRIPTION_ERROR;
  if (
    (0, validatorHelpers_1.wrongType)(img, "string") ||
    (0, validatorHelpers_1.stringIsEmpty)(img) ||
    (0, validatorHelpers_1.stringLengthExeeds)(img, 255)
  )
    return validationCodes_1.RESPONSE_CODES.DISHES_IMG_ERROR;
  if ((0, validatorHelpers_1.wrongType)(show, "boolean"))
    validationCodes_1.RESPONSE_CODES.DISHES_SHOW_ERROR;
  if ((0, validatorHelpers_1.objectIsEmpty)(weights))
    return validationCodes_1.RESPONSE_CODES.DISHES_WEIGHTS_ERROR;
